...
def test_model(PATH, test_imgs, test_aud, test_text, test_labels, test_lengths, max_length):
    ...
    with torch.no_grad():
        for fold in range(1):
            ...
            model_path = PATH.replace("ee", "ee"+str(fold))
